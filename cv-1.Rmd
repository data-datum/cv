...
- <i class="fa fa-twitter"></i>[Rladies-Rcia-Ctes](https://twitter.com/rladies_rciacte)
<br>
<i class="fa fa-twitter"></i>[R-en-el-Nea](https://twitter.com/NeaRenel)
:::
...
Massive Online Open Courses {data-icon=book-open}
----------------------------------------------------------------------------------

```{r}
print_section(position_data,'mooc')
```
